...
export function BracketsWindow() {
  ...
  if (!view) return <p role="status">Loading the brackets...</p>;
  ...
  return (
    <div className="grid gap-3">
      <section className="xp-group" aria-label="Playoffs">
        <h3 className="xp-group-title">Playoffs</h3>
        {view.projected && (
      ...
      <section className="xp-group" aria-label="Toilet Bowl">
        <h3 className="xp-group-title">Toilet Bowl</h3>
